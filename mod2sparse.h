...
#define Mod2sparse_block                                                       \
    10 /* Number of entries to block together for                              \
          memory allocation */
...
#define mod2sparse_first_in_row(m, i)                                          \
    ((m)->rows[i].right)                                  /* Find the first   */
...
#define mod2sparse_at_end(e)                                                   \
    ((e)->row < 0) /* See if we've reached the end     */
...
#define mod2sparse_rows(m) ((m)->n_rows) /* Get the number of rows or          \
                                            columns*/
...
int mod2sparse_decomp(mod2sparse *, int, mod2sparse *, mod2sparse *, int *,
                      int *, mod2sparse_strategy, int, int);
