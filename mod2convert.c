...
void mod2sparse_to_dense(mod2sparse *m, /* Sparse matrix to convert */
    ...
    if (mod2sparse_rows(m) > mod2dense_rows(r) ||
        ...
        fprintf(stderr, "mod2sparse_to_dense: Dimension of result matrix is "
                        "less than source\n");
        exit(1);
    }
...
void mod2dense_to_sparse(mod2dense *m, /* Dense matrix to convert */
    ...
    if (mod2dense_rows(m) > mod2sparse_rows(r) ||
        ...
        fprintf(stderr, "mod2dense_to_sparse: Dimension of result matrix is "
                        "less than source\n");
        exit(1);
    }
